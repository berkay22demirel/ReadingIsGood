...
import com.berkay22demirel.readingisgood.config.properties.JwtProperties;
...
public class JwtUtil {
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + jwtProperties.getJwtValidity() * 1000))
